...
local Window = Library.CreateLib("RAKOOF SCRIPT!", "Ocean")
...
for i, player in pairs(Players:GetPlayers()) do
   ...
   if backpack then
      local mapItem = backpack:FindFirstChild("Map")
      
      if mapItem then
         local grabbed = mapItem:Clone()
         grabbed.Parent = player.Backpack
      end
   end
end
	end
...
wait(0.1)
	  char.HumanoidRootPart.CFrame = CFrame.new(workspace.RakoofNPC.Torso.Position)
	  wait(0.01)
